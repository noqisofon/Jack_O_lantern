...
/*!
 * \def JOL_COMPILE_WITH_SDL_DEVICE
 * SDL Device をコンパイルすることを表します。
 */
//#define JOL_COMPILE_WITH_SDL_DEVICE

/*!
 * \def JOL_COMPILE_WITH_SDL2_DEVICE
 * SDL2 Device をコンパイルすることを表します。
 */
#define JOL_COMPILE_WITH_SDL2_DEVICE
...
/*!
 * \def JOL_PLATFORM_IS_WINDOWS
 * Jack_O_Lantern のプラットフォームとして Windows が使われることを表します。
 */
#   define     JOL_PLATFORM_IS_WINDOWS

/*!
 * \def JOL_USING_WINDOWS_API
 * Jack_O_Lantern が Windows API を使用することを表します。
 */
#   define     JOL_USING_WINDOWS_API

/*!
 * \def JOL_COMPILE_WITH_WINDOWS_DEVICE
 * Windows Device をコンパイルすることを表します。
 */
